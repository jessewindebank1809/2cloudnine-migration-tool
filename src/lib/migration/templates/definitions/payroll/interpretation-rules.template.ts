    ...
    etlSteps: [
        {
            ...
            extractConfig: {
                soqlQuery: `SELECT Id, Name, RecordType.Name, tc9_et__Apply_4_Week_Frequency__c,
                    ...
                    tc9_et__Sleepover_Minimum_Rest_Hours__c, tc9_et__Sleepover_Minimum_Paid_Hours__c,
            ...
            transformConfig: {
                fieldMappings: [
                    ...
                    {
                        sourceField: "tc9_et__Sleepover_Minimum_Paid_Hours__c",
                        targetField: "tc9_et__Sleepover_Minimum_Paid_Hours__c",
                        isRequired: false,
                        transformationType: "number"
                    },
                    {
            ...
            return [
                {
                    ...
                    extractConfig: {
                        soqlQuery: `SELECT Id, Name, RecordType.Name, tc9_et__Interpretation_Rule__c,
                            ...
                            tc9_et__Public_Holiday_Pay_Code__r.{externalIdField}, tc9_et__Public_Holiday_Pay_Code__r.Name, tc9_et__Public_Holiday_Overtime_Pay_Code__r.{externalIdField}, tc9_et__Public_Holiday_Overtime_Pay_Code__r.Name,
